class Showkey < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_tahoe:    "1c630fa31441f7dd28d2031d45523f39ea47e8fa55c8c9f8b2b35966690b7955"
  ...
  test do
    ...
    assert_match "Hello<SP>Homebrew!<CTL-D=EOT>\r\nBye...\r\n", output
  end
end
